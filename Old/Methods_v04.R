...
#declared only once in Stimulus_declaration_block, have two realizations in AOI_realization_block and Stimulus_realization_block
...
setMethod("mAddRecords",  "RawDataTable",                                   
          ...
          {                         
            ...
            {
              # User can load data using his own function and settings
              source(Parser@settings$funpath)
              fun <- Parser@settings$funname
              funSettings <- Parser@settings$funsettings
              Parser@
              rawDataRecords <- fun(path, funSettings)
              append(self, rawDataRecords)
            }
