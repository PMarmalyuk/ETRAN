...
setClass("dataSettings",
         ...
         prototype(availableDataFields = list(time = NA, trial = NA, frame = NA, stimname = NA, smptype = NA,
                                              ...
                                              additionalFields = NA # e.g. list(lrawx = "L Raw X [px]", lrawy = "L Raw Y [px]", etc.)
         ),
         eyeTracker = NA,
         dataFormat = NA,
         eye = NA,
         ...
         eyeToCameraDistance = NA,
         chinRestDistances = NA,
         distancesUnits = NA, 
         pupilShape = NA,
         pupilDataType = NA,
         pupilDataUnits = NA
...
setClass("Experiments",
         representation(experiments = "list"
         ),
         prototype(
         )
)
...
# Maybe it is needed to create a Filter class?
#setClass("InitialFilter",
#)
...
setClass("Monocular",
         representation(trial = "numeric", 
                        eye = "character", # "left" or "right"
                        conditions = "list", # sampleRate, timeUnitsExponential, pupilDataType, pupilDataUnits, screenDistance etc.
                        time = "list",
                        frame = "list",
                        eyeSamples = "Trajectory",
                        pupilSamples = "PupilData",
                        otherSamples = "OtherData",
                        filterResults = "FilterMarkers",
                        eventDetectionResults = "EventMarkers",
                        eyeEvents = "EventData"
         ),
         prototype(conditions = list(eyeTracker = "Unknown",
                                     sampleRate = 0, # Hz, 
                                     timeUnitsExp = 1E-3, #1E-e is milliseconds by default, 
                                     screenDistance = 1,
                                     screenDistanceUnits = 1E-1 #1E-1 is centimeters by default),
                                     ),
                   trialID = -1
         )
)
...
setClass("Binocular",
         representation(trial = "numeric",
                        time = "list",
                        frame = "list",
                        leftEyeSamples = "Trajectory",
                        rightEyeSamples = "Trajectory",
                        leftPupilSamples = "PupilData",
                        rightPupilSamples = "PupilData",
                        leftOtherSamples = "OtherData",
                        rightOtherSamples = "OtherData",
                        leftFilterResults = "FilterMarkers",
                        rightFilterResults = "FilterMarkers",
...
setClass("TrialData",
         representation(fileSource = "character",
                        eyeData = "list"
                        ),
         prototype(eyeData = list(trajData, pupilData, otherData, )
         )
)
